...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AuthorSnippet.author_image'
        db.add_column(u'wagtailsite_authorsnippet', 'author_image',
        ...
        db.delete_column(u'wagtailsite_blogpage', 'intro')
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AuthorSnippet.author_image'
        db.delete_column(u'wagtailsite_authorsnippet', 'author_image_id')

        # Adding field 'BlogPage.intro'
        db.add_column(u'wagtailsite_blogpage', 'intro',
