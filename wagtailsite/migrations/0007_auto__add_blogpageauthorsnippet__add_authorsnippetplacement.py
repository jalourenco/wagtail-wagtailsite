...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AuthorSnippetPlacement'
        db.create_table(u'wagtailsite_authorsnippetplacement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='author_snippet_placements', to=orm['wagtailcore.Page'])),
            ('author_snippet', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['wagtailsite.AuthorSnippet'])),
        ))
        db.send_create_signal(u'wagtailsite', ['AuthorSnippetPlacement'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AuthorSnippetPlacement'
        db.delete_table(u'wagtailsite_authorsnippetplacement')
    ...
    models = {
        ...
        u'wagtailsite.authorsnippet': {
            ...
            'author_image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['wagtailimages.Image']"}),
        ...
        u'wagtailsite.authorsnippetplacement': {
            'Meta': {'object_name': 'AuthorSnippetPlacement'},
            'author_snippet': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['wagtailsite.AuthorSnippet']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('modelcluster.fields.ParentalKey', [], {'related_name': "'author_snippet_placements'", 'to': u"orm['wagtailcore.Page']"})
        },
