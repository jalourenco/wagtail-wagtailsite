...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AuthorSnippet'
        db.create_table(u'wagtailsite_authorsnippet', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('author_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('author_title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('author_biog', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('author_link', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('author_link_text', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('author_twitter', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('author_twitter_text', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'wagtailsite', ['AuthorSnippet'])


    def backwards(self, orm):
        # Deleting model 'AuthorSnippet'
        db.delete_table(u'wagtailsite_authorsnippet')
