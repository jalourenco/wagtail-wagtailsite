...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wagtailsite_blogindexpagerelatedlink', (
            ...
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='related_links', to=orm['wagtailsite.BlogIndexPage'])),
        ))
        db.send_create_signal(u'wagtailsite', ['BlogIndexPageRelatedLink'])

        # Adding model 'BlogPageTag'
        db.create_table(u'wagtailsite_blogpagetag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'wagtailsite_blogpagetag_items', to=orm['taggit.Tag'])),
            ('content_object', self.gf('modelcluster.fields.ParentalKey')(related_name='tagged_items', to=orm['wagtailsite.BlogPage'])),
        ))
        db.send_create_signal(u'wagtailsite', ['BlogPageTag'])

        # Adding model 'BlogIndexPage'
        db.create_table(u'wagtailsite_blogindexpage', (
        ...
        db.send_create_signal(u'wagtailsite', ['BlogIndexPage'])

        # Adding model 'BlogPage'
        db.create_table(u'wagtailsite_blogpage', (
            (u'page_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wagtailcore.Page'], unique=True, primary_key=True)),
            ('intro', self.gf('wagtail.wagtailcore.fields.RichTextField')(blank=True)),
        ...
        db.send_create_signal(u'wagtailsite', ['BlogPage'])

        # Adding model 'BlogPageRelatedLink'
        db.create_table(u'wagtailsite_blogpagerelatedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sort_order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('link_external', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('link_page', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtailcore.Page'])),
            ('link_document', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['wagtaildocs.Document'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('page', self.gf('modelcluster.fields.ParentalKey')(related_name='related_links', to=orm['wagtailsite.BlogPage'])),
        ))
        db.send_create_signal(u'wagtailsite', ['BlogPageRelatedLink'])


    def backwards(self, orm):
        # Deleting model 'BlogIndexPageRelatedLink'
        db.delete_table(u'wagtailsite_blogindexpagerelatedlink')

        # Deleting model 'BlogPageTag'
        db.delete_table(u'wagtailsite_blogpagetag')

        # Deleting model 'BlogIndexPage'
        db.delete_table(u'wagtailsite_blogindexpage')

        # Deleting model 'BlogPage'
        db.delete_table(u'wagtailsite_blogpage')

        # Deleting model 'BlogPageRelatedLink'
        db.delete_table(u'wagtailsite_blogpagerelatedlink')
