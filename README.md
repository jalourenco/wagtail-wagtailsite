...
This project is essentially a clone of [wagtaildemo](http://github.com/torchbox/wagtaildemo), customised for Wagtail's own product site.
...
Run the following commands:
    ...
    git clone https://github.com/torchbox/wagtail-wagtailsite.git
    cd wagtail-wagtailsite
    vagrant up
    vagrant ssh
